...
<p align="center">
  Estudante de Ciência da Computação no IFSC
</p>
...
Sou estudante da sétima fase do curso de Ciência da Computação no Instituto Federal de Santa Catarina (IFSC). Durante o curso, desenvolvi uma base sólida em Java. Atualmente, estou expandindo meus conhecimentos em JavaScript e Python, além de Vue.js e Django.
